...
const icon6=<i className="devicon-nextjs-original colored" style={{fontSize: 54, margin:"20px"}}/>
const icon7=<i className="devicon-materialui-plain" style={{fontSize: 54, margin:"20px"}}/>
